...
interes = 0.04
monto_inicial = float(input("Cuál es el monto iniciual de tu ahorro: "))
...
print(f'Cantidad en tu cuenta después del primer año: {round(saldo_anio1, 2)}')
print(f'Cantidad en tu cuenta después del segundo año: {round(saldo_anio2, 2)}')
print(f'Cantidad en tu cuenta después del tercer año: {round(saldo_anio3, 2)}')
